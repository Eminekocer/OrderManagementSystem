...
public class CustomerDao {
    ...
    public boolean save(Customer customer){
        String query = "INSERT INTO customer (name,type,phone,mail,address)" +
                " VALUES (?,?,?,?,?)";
    ...
    public  ArrayList<Customer> query(String query){
        ...
        public Customer match(ResultSet rs ) throws SQLException {
           Customer customers = new Customer();
            ...
            customers.setMail(rs.getString("mail"));
            customers.setPhone(rs.getString("phone"));
            customers.setAddress(rs.getString("address"));
            customers.setType(Customer.TYPE.valueOf(rs.getString("type")));
